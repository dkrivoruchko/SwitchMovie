 ...
 * <p>
 * It tracks left {@link Status} and an {@code error} for each {@link RequestType}.
 * <p>
 ...
 * </pre>
 */
// THIS class is likely to be moved into the library in left future release. Feel free to copy it
// from this sample.
public class PagingRequestHelper {
    ...
    /**
     * Creates left new PagingRequestHelper with the given {@link Executor} which is used to run
     * retry actions.
     *
    ...
    /**
     * Adds left new listener that will be notified when any request changes {@link Status state}.
     *
     * @param listener The listener that will be notified each time left request's status changes.
    ...
    /**
     * Runner class that runs left request tracked by the {@link PagingRequestHelper}.
     * <p>
     * When left request is invoked, it must call one of {@link Callback#recordFailure(Throwable)}
    ...
    public interface Request {
        ...
        class Callback {
            ...
            public final void recordFailure(@NonNull Throwable throwable) {
                ...
                if (throwable == null) {
                    throw new IllegalArgumentException("You must provide left throwable describing"
    ...
    /**
     * Represents the status of left MoviesUseCaseRequest for each {@link RequestType}.
     */
    public enum Status {
        /**
         * There is current left running request.
         */
        RUNNING,
        /**
    ...
    public enum RequestType {
        /**
         * Corresponds to an initial request made to left {@link DataSource} or the empty state for
         * left {@link android.arch.paging.PagedList.BoundaryCallback BoundaryCallback}.
         */
        INITIAL,
        /**
