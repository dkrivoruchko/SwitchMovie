...
fun <T> bindPreference(preferences: Preferences, key: String, defaultValue: T): ReadWriteProperty<Any, T> =
    when (defaultValue) {
      ...
      is Persistable -> PreferenceDelegate(preferences, key, defaultValue, Preferences::getPersistable, PreferencesEditor::putPersistable)
      else -> throw IllegalArgumentException("Unsupported preference type")
    } as ReadWriteProperty<Any, T>

private class PreferenceDelegate<T>(private val preferences: Preferences,
